...
// msh bermasalah dengan attachnya
...
describe('Product Routes', function () {
  ...
  //       chai.request(app)
  //         .post(link)
  //         .field('condition', 'allnew')
  //         .field('description', 'allnew Product')
  //         .field('name', 'yayay')
  //         .field('price', 9221)
  //         .field('stock', 20)
  //         .field('StoreId', '0707788967892' )
  //         .field('category', 'apa')
  //         .set('token', initialToken)
  //         .attach('image', fs.readFileSync('../newslRoadster.jpg', '../newslRoadster.jpg'))
