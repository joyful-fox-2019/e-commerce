    ...
    <div class="box">
      <form @submit.prevent="login">
        ...
        <div class="input">
          ...
          <input type="text" id="name" v-model="emaillog">
          <span class="spin"></span>
        </div>

        <div class="input">
          <label for="pass">Password</label>
          <input type="password" id="pass" v-model="passwordlog">
          <span class="spin"></span>
        </div>
    ...
    <div class="overbox">
       <form @submit.prevent="register">
         ...
         <div class="input">
            ...
            <input type="text" id="regname" v-model="usernamereg">
            <span class="spin"></span>
         </div>

         <div class="input">
            <label for="regpass">Email</label>
            <input type="text" id="regpass" v-model="emailreg">
            <span class="spin"></span>
         </div>

         <div class="input">
            <label for="reregpass">Password</label>
            <input type="password" id="reregpass" v-model="passwordreg">
            <span class="spin"></span>
         </div>
