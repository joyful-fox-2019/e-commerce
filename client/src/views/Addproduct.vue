  ...
  <div>
    ...
    <q-card square class="shadow-24" style="width:700px; height:600px;">
      <q-card-section class="bg-blue-grey-5">
        ...
        <div class="text-h4 absolute-right" style="margin-top:40px; margin-right:10px;">Add Product</div>
      </q-card-section>
      <q-card-section>
      ...
      <q-card-actions class="q-px-lg">
        <q-btn @click.prevent="addproduct" unelevated size="lg" color="blue-grey-14" class="full-width text-white" label="Add Product" />
      </q-card-actions>
    </q-card>
  </q-page>
  </div>
