        ...
        <div class="box-down">
          ...
          <a class="cart" href="#">
            ...
            <span class="add-to-cart">
              <router-link :to='{name: "detail", params: { id: getProduct._id }}'><span class="txt">Detail</span></router-link>
              <button class="btn-sm btn-outline-danger btn ml-2" v-if='isWish' @click='removeWish(getProduct._id)'>Remove</button>
            </span>
          </a>
        </div>
      </div>
